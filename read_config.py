...
def read_config_subscriber(config_file):
    ...
    with open(path.join(path.dirname(config_file), config['private_key_signing_file'])) as private_key_file:
        config['private_key_signing'] = json.load(private_key_file)
